...
import { PrivateCloudComponent } from 'app/entities/privateCloud/private-cloud/private-cloud.component';
...
describe('Component Tests', () => {
  describe('PrivateCloud Management Component', () => {
    let comp: PrivateCloudComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PrivateCloudComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.privateClouds[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
