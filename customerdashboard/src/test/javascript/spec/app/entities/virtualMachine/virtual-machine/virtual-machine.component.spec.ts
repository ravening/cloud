...
import { VirtualMachineComponent } from 'app/entities/virtualMachine/virtual-machine/virtual-machine.component';
...
describe('Component Tests', () => {
  describe('VirtualMachine Management Component', () => {
    let comp: VirtualMachineComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(VirtualMachineComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.virtualMachines[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
