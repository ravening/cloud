package com.rakeshv.hackathon.vps.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("virtualMachine");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("virtualMachine");
        ...
        config.getMapConfigs().put("com.rakeshv.hackathon.vps.domain.*", initializeDomainMapConfig(jHipsterProperties));
