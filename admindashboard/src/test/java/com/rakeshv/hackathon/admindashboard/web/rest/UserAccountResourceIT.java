...
import com.rakeshv.hackathon.admindashboard.repository.UserAccountRepository;
...
public class UserAccountResourceIT {
    ...
    private static final String DEFAULT_EMAIL = ":X@%.Z7";
    private static final String UPDATED_EMAIL = "{r@Q.qA";
