package com.rakeshv.hackathon.account.web.rest;

import com.rakeshv.hackathon.account.CustomerAccountApp;
import com.rakeshv.hackathon.account.domain.UserAccount;
import com.rakeshv.hackathon.account.repository.UserAccountRepository;
import com.rakeshv.hackathon.account.web.rest.errors.ExceptionTranslator;
...
import static com.rakeshv.hackathon.account.web.rest.TestUtil.createFormattingConversionService;
 ...
 */
@SpringBootTest(classes = CustomerAccountApp.class)
public class UserAccountResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "EF@)a.3";
    private static final String UPDATED_EMAIL = "l@}I.*0";
