package com.rakeshv.hackathon.account.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("customerAccount");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("customerAccount");
        ...
        config.getMapConfigs().put("com.rakeshv.hackathon.account.domain.*", initializeDomainMapConfig(jHipsterProperties));
