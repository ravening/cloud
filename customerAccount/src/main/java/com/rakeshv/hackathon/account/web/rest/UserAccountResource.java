...
import com.rakeshv.hackathon.account.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.rakeshv.hackathon.account.domain.UserAccount}.
 */
@RestController
@RequestMapping("/api")
public class UserAccountResource {
    ...
    private static final String ENTITY_NAME = "customerAccountUserAccount";
