package com.rakeshv.hackathon.csrp.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("privateCloud");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("privateCloud");
        ...
        config.getMapConfigs().put("com.rakeshv.hackathon.csrp.domain.*", initializeDomainMapConfig(jHipsterProperties));
